...
class MenuView(View):
    ...
    # проверить можно ли во вьюхе писать метод инит
    def __init__(self):
        self.URL_LIST = (
...
class SubMenuView(View):
    ...
    def __init__(self):
        self.URL_LIST = (
            'kitchen_url',
            'house_url',
            'beautifil_health_url', # исправить опечатку везде!
...
class DeleteToCartView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        cart.products.remove(cart_product)  # удаляет товар из html шаблона
        cart_product.delete()  # удаляет товар из базы данных
        cart.save()
